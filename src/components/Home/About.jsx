...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Just had my car done by Detailed by TJ and honestly it looks better than the day I picked it up. The attention to detail was spot on every panel, every crease, even the bits you never normally see were spotless. TJ was professional, easy to deal with and clearly takes pride in his work. If you want someone who genuinely cares about the finish, I’d highly recommend. Great service!!",
    name: "Sam Bacon",
  },
